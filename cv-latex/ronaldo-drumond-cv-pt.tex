...
\begin{document}
\name{Ronaldo Drumond}
\tagline{Desenvolvimento de Sistemas}
...
\cvsection[page1sidebar.en]{Experiências}

\cvevent{Estágio Administração de Sistemas}{Centro Nacional de Pesquisa Científica (CNRS)}{March 2018 -- June 2018}{Grenoble, France}
